...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
            { "~FIRST TASK~" },
            { "Matrix Operations", "Addition", "Soustraction", "Multiplication" },
            { "~SECOND TASK~" },
            { "Filters Image", "Noise", "Invert", "GrayScale", "Brightness" },
            { "Logout" }
    };

    private final List<MenuEvent> events = new ArrayList<>();
    private final String headerName = "Application Name";
    ...
    private void init() {
        ...
        header.setHorizontalAlignment(SwingConstants.CENTER); // Center the header

        // header.setIcon(new
        // ImageIcon(getClass().getResource("/raven/icon/png/logo.png")));
