...
public class FormEdge extends javax.swing.JPanel {
    ...
    public FormEdge(Socket socket, ObjectOutputStream oos, ObjectInputStream ois) {
        this.socket = socket;
        this.oos = oos;
    ...
    private void initComponents() {
        ...
        lb.setText("Filter Edge Detection");
        ...
        okButton.addActionListener(e -> {
            try {
                ...
                if (intensity > 100) {
                    Notifications.getInstance().show(Notifications.Type.INFO,
                            Notifications.Location.TOP_RIGHT,
                            "Intensity value must be enter [0 - 255].");
                    return;
                }
