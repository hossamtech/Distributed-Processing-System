...
public class FormBrightness extends javax.swing.JPanel {
    ...
    public FormBrightness(Socket socket, ObjectOutputStream oos, ObjectInputStream ois) {
        this.socket = socket;
        this.oos = oos;
    ...
    private void initComponents() {
        ...
        imagePanel.setPreferredSize(new Dimension(813, 425)); // Example size, adjust as needed

        // Assuming jPanel1 is where you intend to display the image, add imagePanel to
        // it
        jPanel1.setLayout(new BorderLayout()); // Set layout manager
        jPanel1.add(imagePanel, BorderLayout.CENTER); // Add imagePanel to jPanel1

        lb.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lb.setText("Filter Brightness");
    ...
    private void buttonApplyFilterActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        intensityField.setText("-255 - 255");
        ...
        okButton.addActionListener(e -> {
            try {
                ...
                if (intensity < -255 || intensity > 255) {
                    Notifications.getInstance().show(Notifications.Type.INFO,
                            Notifications.Location.TOP_RIGHT,
                            "Intensity value must be enter [-255 - 255].");
                    return;
                }
