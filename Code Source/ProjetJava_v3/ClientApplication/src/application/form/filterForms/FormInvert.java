...
public class FormInvert extends javax.swing.JPanel {
    ...
    public FormInvert(Socket socket, ObjectOutputStream oos, ObjectInputStream ois) {
        this.socket = socket;
        this.oos = oos;
